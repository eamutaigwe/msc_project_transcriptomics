...
#pdf(file= "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/EP_downgene_group1_top300_Reactome.pdf", width = 15, height = 15)
a <- barplot(EP_downgene_group1_top300_Reactome, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "REACTOME sig.terms - downreg. genes in E12.5 and E14.5 EP", label_format = 30)
a
#dev.off()
...
a <- barplot(EP_downgene_group1_top300_BP, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "BP sig.terms - upreg. genes in E12.5 and E14.5 EP", label_format = 30)
a
#dev.off()
```
...
REMEMBER TO LIST THESE GENES BELOW ON YOUR SLIDES AND SHOW PLOTS OF SOME OF THEM


```{r}
# Top300 down-regulated genes enriched terms
PLATELET_ACTIVATION_SIGNALING_AND_AGGREGATION - Tmsb4x/Rasgrp2/Gng2/Itga2b/Lat/Gng12/Cd63/Grb2/Lyn/Plcg2/Pf4/Fcer1g/Phactr2/Gnaq/Syk/Gp1bb/Prkcq/Sparc/Itgb3/Plek/Rab27b/Flna/Pecam1/Timp3/Cd9/Vav1/Gna15
RESPONSE_TO_ELEVATED_PLATELET_CYTOSOLIC_CA2 - Tmsb4x/Itga2b/Cd63/Pf4/Phactr2/Sparc/Itgb3/Plek/Rab27b/Flna/Pecam1/Timp3/Cd9

# Top300 up-regulated genes enriched terms
#erythrocyte homeostasis - Ampd3|Epb42|Dmtn|Klf1|Rb1|Rhd|Trim10|Sox6|Tmem14c|Fam210b|Tspo2|Slc25a38
#porphyrin-containing compound metabolic process - Hebp1|Hmbs|Ppox|Spta1|Sptb|Uros|Tmem14c
#cellular response to copper ion - Aqp1|Mt2|Nfe2l2|Prnp|Snca
```
...
#par(mfrow=c(1,3))
a <- VlnPlot(fl_samples_DEG_noCd45, features = c("Rasgrp2"), group.by = "sample_group", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
...
Ery1_seurat_geneExp <- CreateSeuratObject(counts = counts(Erythroblast_upgene_group1_expression),
                                                   meta.data = Erythroblast_upgene_group1_cellInfo)

# Key erthroid genes upregulated
#par(mfrow=c(1,3))
a <- VlnPlot(fl_samples_E10.5_12May_named_subset_DEG_merge_noCd45, features = c("Tfrc"), group.by = "sample_group", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
...
b <- VlnPlot(fl_samples_E12.5_12May_named_subset_DEG_merge, features = c("Tfrc"), group.by = "sample_group", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
...
c <- VlnPlot(fl_samples_E14.5_12May_named_subset_DEG_merge, features = c("Cd24a"), group.by = "sample_group", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
...
d <- VlnPlot(fl_samples_E14.5_12May_named_subset_DEG_merge, features = c("Fli1"), group.by = "sample_group", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
...
```{r}
# Key erythroid genes downrelated

a <- VlnPlot(Ery1_seurat_geneExp, features = c("Hbb-y"), group.by = "sample_grp", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
...
b <- VlnPlot(Ery1_seurat_geneExp, features = c("Hbb-bh1"), group.by = "sample_grp", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
...
c <- VlnPlot(Ery1_seurat_geneExp, features = c("Hba-x"), group.by = "sample_grp", add.noise = FALSE, pt.size = 0, cols = cols_sample_group) + NoLegend() +
  theme(axis.text.x = element_text(face = "bold", size = 50)) +
            theme(axis.text.y = element_text(face = "bold", size = 50)) +
            theme(plot.title = element_text(size = 50, face = "bold")) +
            theme(axis.title.x = element_text(size = 50, face = "bold")) +
