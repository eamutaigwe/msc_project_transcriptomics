...
```{r}
fl_samples_E10.5_12May_named@active.ident <- factor(fl_samples_E10.5_12May_named@active.ident, levels = c("HSC/MPP", "GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "Prim-EB","EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3"))
```


```{r, eval=FALSE}
fl_samples_E10.5_12May_named$cluster_ident <- factor(fl_samples_E10.5_12May_named$cluster_ident, levels = c("HSC/MPP", "GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "Prim-EB","EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3"))
```
...
```{r}
# Set colors
clust_cols <- c(EP1 = "#16FF32", EP2 = "#F7E1A0", EP3 = "#1CFFCE", Mk1 = "#DEA0FD",  Mk2 = "#F8A19F", MCP = "#E2E2E2", PEB1 = "#2ED9FF", PEB2 = "#C4451C", Mono = "#FBE426", Mac = "darkorange2", `GMP/GP` = "grey60", MEP = "#F6222E",  PEB3 = "#FE00FA", `Prim-EB` = "#1C8356", `HSC/MPP` = "#00AFBB")
```
...
ggplot(ncells_E10.5, aes(x = Clusters, y = Freq, fill = Clusters)) +
  geom_col() +
  scale_fill_manual(values = c(EP1 = "#16FF32", EP2 = "#F7E1A0", EP3 = "#1CFFCE", Mk1 = "#DEA0FD",  Mk2 = "#F8A19F", MCP = "#E2E2E2", PEB1 = "#2ED9FF", PEB2 = "#C4451C", Mono = "#FBE426", Mac = "darkorange2", `GMP/GP` = "grey60", MEP = "#F6222E",  PEB3 = "#FE00FA", `Prim-EB` = "#1C8356", `HSC/MPP` = "#00AFBB")) +
...
Clustered_DotPlot(seurat_object = fl_samples_E10.5_12May_named, features = c("Gypa", "Tfrc", "Gata1", "Kit", "Hba-x", "Hbb-y", "Gata2", "Spi1", "Csf1r", "Pf4", "Vwf", "Elane", "Hp", "Cx3cr1", "Ifitm1", "Irf8", "Itga2b", "Prtn3", "Thbs1","Klf1", "Car1", "Cd34", "Fcgr3", "Ccr2", "C1qa", "C1qb", "Prg2", "Stx3", "Il7r", "Prg3", "Hlf", "Mecom","Prg2", "Ppbp", "S100a8", "Hdc", "Hbb-bs", "Hbb-bt", "Hba-a2", "Rhd", "Hdc", "Cpa3", "Gp1bb", "Cd24a","Hoxa9", "Hoxa7", "Myb", "Epor", "Mpo", "Rhd", "Ms4a3", "Perp", "Muc13", "Plek", "F2r", "Cd93", "Rag1", "Ccl9", "Ccr9", "Ly6a"), k = 9, show_parent_dend_line = FALSE, plot_km_elbow = FALSE, cluster_ident = FALSE,  column_label_size = 10, row_label_size = 10, row_label_fontface = "bold",colors_use_idents = c(`HSC/MPP` = "#00AFBB", `GMP/GP` = "grey60", Mono = "#FBE426", Mac = "darkorange2", MCP = "#E2E2E2", MEP = "#F6222E", Mk1 = "#DEA0FD",  Mk2 = "#F8A19F", `Prim-EB` = "#1C8356", EP1 = "#16FF32", EP2 = "#F7E1A0", EP3 = "#1CFFCE",   PEB1 = "#2ED9FF", PEB2 = "#C4451C", PEB3 = "#FE00FA"), colors_use_exp = c(low="lightgrey", mid="grey", high="red"))
...
clust <- c("HSC/MPP", "GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "Prim-EB","EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3")
...
DoHeatmap(subset(fl_samples_E10.5_12May_named, downsample = 100),
          ...
          group.colors = c(EP1 = "#16FF32", EP2 = "#F7E1A0", EP3 = "#1CFFCE", Mk1 = "#DEA0FD",  Mk2 = "#F8A19F", MCP = "#E2E2E2", PEB1 = "#2ED9FF", PEB2 = "#C4451C", Mono = "#FBE426", Mac = "darkorange2", `GMP/GP` = "grey60", MEP = "#F6222E",  PEB3 = "#FE00FA", `Prim-EB` = "#1C8356", `HSC/MPP` = "#00AFBB"),
          angle = 45) +
...
```{r, eval=FALSE}
fl_samples_E10.5_12May_named_subset <- subset(fl_samples_E10.5_12May_named, idents =c("MEP", "Mk1", "Mk2", "EP1", "EP2", "EP3",  "PEB1", "PEB2", "PEB3"))
```
...
```{r}
# Set colors
clust_cols_subset <- c(EP1 = "dodgerblue3", EP2 = "#F7E1A0", EP3 = "#1CFFCE", Mk1 = "#DEA0FD", Mk2 = "lightsteelblue4",PEB1 = "#2ED9FF", PEB2 = "#C4451C", MEP = "#F6222E" ,PEB3 = "#FE00FA")
```
EP5a = "#325A9B", 
...
```{r}
EP1_vs_EP2_EP3_E10.5_subset <- FindMarkers(fl_samples_E10.5_12May_named, 
                                  ident.1 = "EP1",
                                  ident.2 = c("EP2", "EP3"),
                                  assay = "SCT")
...
```{r}
#EP1_vs_EP2 AND EP3
MEP_vs_EP2_EP3_E10.5_subset <- FindMarkers(fl_samples_E10.5_12May_named, 
                                  ident.1 = "MEP",
                                  ident.2 = c("EP2", "EP3"),
                                  assay = "SCT")
...
```{r}
EP1_vs_MEP_E10.5_subset <- FindMarkers(fl_samples_E10.5_12May_named, 
                                  ident.1 = "EP1",
                                  ident.2 = "MEP",
                                  assay = "SCT")
...
```{r}
EP2_vs_EP1_E10.5_subset <- FindMarkers(fl_samples_E10.5_12May_named, 
                                  ident.1 = "EP2",
                                  ident.2 = "EP1",
                                  assay = "SCT")
...
```{r}
fl_samples_E10.5_12May_named_no_prim_ER <- subset(fl_samples_E10.5_12May_named, idents = c("HSC/MPP","GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3"))
```
...
```{r}
DefaultAssay(fl_samples_E10.5_12May_named_no_prim_ER) <- "RNA"
fl_samples_E10.5_12May_named_no_prim_ER@active.ident <- factor(fl_samples_E10.5_12May_named_no_prim_ER@active.ident, levels = c("HSC/MPP", "GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3"))
```


```{r, eval=FALSE}
fl_samples_E10.5_12May_named_no_prim_ER$cluster_ident <- factor(fl_samples_E10.5_12May_named_no_prim_ER$cluster_ident, levels = c("HSC/MPP", "GMP/GP", "Mono", "Mac", "MCP", "MEP", "Mk1", "Mk2", "EP1", "EP2", "EP3","PEB1", "PEB2", "PEB3"))
```
...
fl_samples_E10.5_12May_named_no_prim_ER1 <- fl_samples_E10.5_12May_named_no_prim_ER

# save metadata table
fl_samples_E10.5_12May_named_no_prim_ER1$barcode <- colnames(fl_samples_E10.5_12May_named_no_prim_ER1)
fl_samples_E10.5_12May_named_no_prim_ER1$UMAP_1 <- fl_samples_E10.5_12May_named_no_prim_ER1@reductions$umap@cell.embeddings[,1]
fl_samples_E10.5_12May_named_no_prim_ER1$UMAP_2 <- fl_samples_E10.5_12May_named_no_prim_ER1@reductions$umap@cell.embeddings[,2]
```  


```{r}
# Select column variables of interest
Ery_E10.5_metadata <- fl_samples_E10.5_12May_named_no_prim_ER1@meta.data
...
fl_samples_E10.5_12May_named_no_prim_ER1@meta.data <- Ery_E10.5_metadata
```

```{r}
write.csv(fl_samples_E10.5_12May_named_no_prim_ER1@meta.data, file = paste0(E10.5_rnavelo, "full_E10.5_metadata.csv"), quote = F, row.names = F)
...
Ery_E10.5_counts_matrix <- GetAssayData(fl_samples_E10.5_12May_named_no_prim_ER1, assay = "RNA", layer = "counts") 
#Ery_E10.5_counts_matrix <- Ery_E10.5_counts_matrix %>% as.data.frame() 
write.csv(Ery_E10.5_counts_matrix, "rnavelocity/E10.5_rnavelocity/full_E10.5_counts.csv", quote = F, row.names = T)
```
...
write.csv(fl_samples_E10.5_12May_named_no_prim_ER1@reductions$pca@cell.embeddings, file = paste0(E10.5_rnavelo, "full_E10.5_pca.csv"), quote = F, row.names = F)
```


```{r}
# Write gene names
write.table(data.frame("gene" = rownames(Ery_E10.5_counts_matrix)), file = paste0(E10.5_rnavelo, "full_E10.5_gene_names.csv"), quote = F, row.names = F, col.names = F)
```
