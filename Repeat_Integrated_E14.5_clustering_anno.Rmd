...
# Set colors
# Set colors
clust_cols_subset <- c(EP1a = "#16FF32", EP1b =  "#2ED9FF", EP2a = "#FE00FA", EP2b = "#DEA0FD", EP3a = "grey60", EP4a = "darkorange2", EP5a = "#90AD1C", MEP = "#F6222E", Mk = "#00AFBB", PEBa = "#3283FE", PEBb = "#1CFFCE", PEBc = "goldenrod1")
...
clust <- c("MEP", "Mk", "EP1a", "EP2a", "EP3a", "EP4a", "EP5a", "PEBa", "EP1b", "EP2b","PEBb", "PEBc")
...
DoHeatmap(subset(fl_samples_E14.5_12May_named_subset_regressed, downsample = 100),
          ...
          group.colors = c(EP1a = "#16FF32", EP1b =  "#2ED9FF", EP2a = "#FE00FA", EP2b = "#DEA0FD", EP3a = "grey60", EP4a = "darkorange2", EP5a = "#90AD1C", MEP = "#F6222E", Mk = "#00AFBB", PEBa = "#3283FE", PEBb = "#1CFFCE", PEBc = "goldenrod1"), 
          angle = 45) +
...
```{r}
fl_samples_E14.5_12May_named_subset_regressed@active.ident <- factor(fl_samples_E14.5_12May_named_subset_regressed@active.ident, levels = c("MEP", "Mk", "EP1a", "EP2a", "EP3a", "EP4a", "EP5a", "PEBa", "EP1b", "EP2b", "PEBb", "PEBc"))
```


```{r, eval=FALSE}
fl_samples_E14.5_12May_named_subset_regressed$cluster_ident <- factor(fl_samples_E14.5_12May_named_subset_regressed$cluster_ident, levels = c("MEP", "Mk", "EP1a", "EP2a", "EP3a", "EP4a", "EP5a", "PEBa", "EP1b", "EP2b", "PEBb", "PEBc"))
```
...
ggplot(ncells_E14.5, aes(x = Clusters, y = Freq, fill = Clusters)) +
  geom_col() +
  scale_fill_manual(values = c(EP1a = "#16FF32", EP1b =  "#2ED9FF", EP2a = "#FE00FA", EP2b = "#DEA0FD", EP3a = "grey60", EP4a = "darkorange2", EP5a = "#90AD1C", MEP = "#F6222E", Mk = "#00AFBB", PEBa = "#3283FE", PEBb = "#1CFFCE", PEBc = "goldenrod1")) +
  theme(axis.text = element_text(size = 50),
        panel.background = element_rect(fill = "white"), 
        plot.background = element_rect(fill = "white", colour = "black", linewidth = 1.2)) +
        theme(axis.title.x = element_text(size =50, face = "bold")) +
...
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_Reactome <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif$gene, TERM2GENE = msigdbr_t2g1)
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_Reactome@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_Reactome@result$Description %>% str_replace_all("REACTOME_", "")


EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_BP <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif$gene, TERM2GENE = msigdbr_t2g2)
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_BP@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_BP@result$Description %>% str_replace_all("GOBP_", "")
```


```{r}
require(DOSE)
dotplot(EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_signif_Reactome, showCategory = 10, split = ".sign") + facet_grid(.~.sign)
```
...
# ENRICHER
# Up_regulated genes
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_Reactome <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg$gene, TERM2GENE = msigdbr_t2g1) 
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_Reactome@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_Reactome@result$Description %>% str_replace_all("REACTOME_", "")

EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_BP <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg$gene, TERM2GENE = msigdbr_t2g2) 
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_BP@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_BP@result$Description %>% str_replace_all("GOBP_", "")
```
...
# Plot up-regulated genes
#pdf(file= "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_Reactome.pdf", width = 15, height = 15)
a <- barplot(EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_Reactome, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "REACTOME sig.terms - upreg. genes in E14.5 EPa vs EPb", label_format = 30)
a
#dev.off()


#pdf(file= "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_BP.pdf", width = 15, height = 15)
a <- barplot(EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_upreg_BP, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "BP sig.terms - upreg. genes in E14.5 EPa vs EPb", label_format = 30)
a
#dev.off()
```
...
# ENRICHER
# Down_regulated genes
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_Reactome <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg$gene, TERM2GENE = msigdbr_t2g1)
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_Reactome@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_Reactome@result$Description %>% str_replace_all("REACTOME_", "")


EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_BP <- enricher(gene = EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg$gene, TERM2GENE = msigdbr_t2g2)
EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_BP@result$Description <- EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_BP@result$Description %>% str_replace_all("GOBP_", "")
```
...
# Plot down-regulated genes
#pdf(file= "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_Reactome.pdf", width = 15, height = 15)
a <- barplot(EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_Reactome, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "REACTOME sig.terms - downreg. genes in E14.5 EPa vs EPb", label_format = 30)
a
#dev.off()

#pdf(file= "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_BP.pdf", width = 15, height = 15)
a <- barplot(EPa_vs_EPb_E14.5_regressedsexandsexgenes_nosexdoublets_downreg_BP, x = "Count", color = "p.adjust", showCategory = 15, font.size = 14, title = "BP sig.terms - downreg. genes in E14.5 EPa vs EPb", label_format = 30)
a
#dev.off()
```
...
```{r}
#gse <- gseGO(geneList = gene_list_E14.5,
             ont = "BP",
             keyType = "SYMBOL",
             nPerm = 10000,
             minGSSize = 1,
...
```{r}
gsereactome_E14.5 <- gseReactome(geneList = gene_list_E14.5_reactome,
             organism = "mouse",
             exponent = 1,
             nPerm = 10000,
             minGSSize = 1,
...
```{r}
require(DOSE)
dotplot(gsereactome_E14.5, showCategory = 10, split = ".sign") + facet_grid(.~.sign)
```
...
```{r, eval=FALSE}
DefaultAssay(fl_samples_E14.5_12May_named_subset_regressed_named) <- "RNA"
# code from the internet on how to remove specific genes before downstream analysis (Satijalab, Github)
counts <- GetAssayData(fl_samples_E14.5_12May_named_subset_regressed_named, assay = "RNA")
counts <- counts[-(which(rownames(counts) %in% sex_genes_vector)),]
fl_samples_E14.5_12May_named_subset_regressed_named_sexgenesout <- subset(fl_samples_E14.5_12May_named_subset_regressed_named, features = rownames(counts))
```
...
```{r}
# SCTransform the subset Ery object
fl_samples_E14.5_12May_named_subset_regressed_named_sexgenesout <- SCTransform(fl_samples_E14.5_12May_named_subset_regressed_named_sexgenesout,
                                   vst.flavor = "v2",
                                   vars.to.regress = c("mitoRatio", "S.Score", "G2M.Score"),
                                   variable.features.n = 3000,
                                   verbose = FALSE)
...
```{r}
EPa_vs_EPb_E14.5_regressed_sexgenesout <- FindMarkers(fl_samples_E14.5_12May_named_subset_regressed_named_sexgenesout, 
                                  ident.1 = "EPa",
                                  ident.2 = "EPb",
                                  assay = "SCT",
                                  min.pct = 0.3)

EPa_vs_EPb_E14.5_regressed_sexgenesout
```


```{r}
# Arrange adjusted p-values
EPa_vs_EPb_E14.5_regressed_sexgenesout <- EPa_vs_EPb_E14.5_regressed_sexgenesout %>% 
  dplyr::arrange("p_val_adj") %>% 
  dplyr::mutate(gene = rownames(EPa_vs_EPb_E14.5_regressed_sexgenesout))

# What is the total number of genes in the DE analysis?
nrow(EPa_vs_EPb_E14.5_regressed_sexgenesout)

# How many genes have significant adjusted p-values,  that is differentially expressed?
EPa_vs_EPb_E14.5_regressed_sexgenesout_signif <- EPa_vs_EPb_E14.5_regressed_sexgenesout %>% 
                              dplyr::filter(p_val_adj < 0.05)
nrow(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif)

# How many genes are upregulated?
(EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg <- EPa_vs_EPb_E14.5_regressed_sexgenesout_signif %>% 
                              dplyr::filter(avg_log2FC > 0))
nrow(EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg)

# How many genes are down-regulated?
(EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg <- EPa_vs_EPb_E14.5_regressed_sexgenesout_signif %>% 
                              dplyr::filter(avg_log2FC < 0))
nrow(EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg)
```


```{r}
# Save the DEGs (all genes, not just the significant ones)
saveRDS(EPa_vs_EPb_E14.5_regressed_sexgenesout,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout.rds")))


# Save significant DEGs
saveRDS(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout_signif.rds")))

# Save upregulated genes
saveRDS(EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg.rds")))
write.csv(EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout_upreg.csv")))

# Save downregulated genes
saveRDS(EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg.rds")))
write.csv(EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg,
          paste0(here("DE_analysis/results/FL_E14.5", "EPa_vs_EPb_E14.5_regressed_sexgenesout_downreg.csv")))
```
...
```{r}
EnhancedVolcano(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif, 
                x = "avg_log2FC", 
                y = "p_val_adj", 
                xlim = c(min(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif[["avg_log2FC"]], na.rm = TRUE) - 0.5, max(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif[["avg_log2FC"]], na.rm = TRUE) + 0.5),
                lab = rownames(EPa_vs_EPb_E14.5_regressed_sexgenesout_signif),
                pCutoff = 10e-5,
                pointSize = 6,
                labSize = 10,
                #drawConnectors = TRUE,
                ...
                title = "", 
                ylab = "-log10(p-val adj)", 
                subtitle = "E14.5 EPa vs EPb sex genes removed", 
                legendLabels = c("Not sig.", expression(Log[2] ~ FC), "p-value", expression(p - value ~ +
                ~ log[2] ~ FC)))

ggsave("EPa.EPb_volcano_fl_samples_E14.5_sexgenes_out.pdf",
       path = "~/myproject/sc_analysis_project/msc_project/DE_analysis/figures/FL_E14.5/",
       width = 15, height = 15)
```
...
saveRDS(markers_fl_samples_E14.5_12May_named_subset_regressed, "~/myproject/sc_analysis_project/msc_project/rds_data/FL_E14.5/markers_fl_samples_E14.5_12May_named_subset_regressed.rds")
...
```{r}
 "#06A5FF""#1C91D4" "#007756""#FF8320" "#B14380""#009E73"
21, 131, 15

   [1] "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756"
  [12] "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320"
  [23] "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00"
  [34] "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442"
  [45] "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380"
  [56] "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2"
  [67] "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B"
  [78] "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666"
  [89] "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3"
 [100] "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D"
 [111] "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00"
 [122] "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711"
 [133] "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD"
 [144] "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9"
 [155] "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2"
 [166] "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D"
 [177] "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6"
 [188] "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800"
 [199] "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700"
 [210] "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71"
 [221] "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA"
 [232] "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9"
 [243] "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685"
 [254] "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C"
 [265] "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45"
 [276] "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00"
 [287] "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D"
 [298] "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E"
 [309] "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666"
 [320] "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4"
 [331] "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF"
 [342] "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3"
 [353] "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73"
 [364] "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700"
 [375] "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57"
 [386] "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D"
 [397] "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7"
 [408] "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF"
 [419] "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF"
 [430] "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D"
 [441] "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756"
 [452] "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320"
 [463] "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00"
 [474] "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442"
 [485] "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380"
 [496] "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2"
 [507] "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B"
 [518] "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666"
 [529] "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3"
 [540] "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D"
 [551] "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00"
 [562] "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711"
 [573] "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD"
 [584] "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9"
 [595] "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2"
 [606] "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D"
 [617] "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6"
 [628] "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800"
 [639] "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700"
 [650] "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71"
 [661] "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA"
 [672] "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9"
 [683] "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685"
 [694] "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C"
 [705] "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45"
 [716] "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00"
 [727] "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D"
 [738] "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E"
 [749] "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666"
 [760] "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4"
 [771] "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF"
 [782] "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3"
 [793] "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73"
 [804] "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700"
 [815] "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57"
 [826] "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D"
 [837] "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7"
 [848] "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF"
 [859] "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF"
 [870] "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D"
 [881] "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756"
 [892] "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320"
 [903] "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00"
 [914] "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442"
 [925] "#0072B2" "#D55E00" "#CC79A7" "#666666" "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380"
 [936] "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3" "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2"
 [947] "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D" "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B"
 [958] "#803800" "#8D3666" "#3D3D3D" "#E69F00" "#56B4E9" "#009E73" "#F0E442" "#0072B2" "#D55E00" "#CC79A7" "#666666"
 [969] "#AD7700" "#1C91D4" "#007756" "#D5C711" "#005685" "#A04700" "#B14380" "#4D4D4D" "#FFBE2D" "#80C7EF" "#00F6B3"
 [980] "#F4EB71" "#06A5FF" "#FF8320" "#D99BBD" "#8C8C8C" "#FFCB57" "#9AD2F2" "#2CFFC6" "#F6EF8E" "#38B7FF" "#FF9B4D"
 [991] "#E0AFCA" "#A3A3A3" "#8A5F00" "#1674A9" "#005F45" "#AA9F0D" "#00446B" "#803800" "#8D3666" "#3D3D3D"
```
