...
E14.5_integrated <- IntegrateData(anchorset = integ_anchors,
                                   normalization.method = "SCT")
saveRDS(E14.5_integrated, "~/myproject/sc_analysis_project/msc_project/rds_data/E14.5_integrated.rds")
...
merged_timepoints@meta.data %>% 
  ggplot(aes(x = sample, fill = sample)) +
  geom_bar(width = 0.5) +
  geom_text(stat = "count", aes(label = ..count.., vjust = 0.5, hjust = -0.1,), size = 10, face = "bold") +
  theme_classic() +
  theme(axis.text.x = element_text(face = "bold", size = 30, angle = 90, vjust = 1, hjust = 1)) +
  theme(axis.text.y = element_text(face = "bold", size = 30)) +
  #theme(axis.text.x = element_text(angle = 45)) +
  scale_y_continuous(breaks = seq(0, 5000, by=3000), limits=c(0,6000), expand = expansion(mult = c(0,0.05))) +
...
a <- VlnPlot(merged_timepoints, group.by = "sample", pt.size = 0, features = "nGene", ncol = 1) +
  theme(axis.text.x = element_text(face = "bold", size = 40, angle = 90)) +
...
a
ggsave("May12th_cell_nGene_info_after_filtering.tif", 
       path = "~/myproject/sc_analysis_project/msc_project/May12th_preprocessing_plots_repeated",
       width = 17, height = 15, device = "tiff")
b
ggsave("May12th_cell_nUMI_info_after_filtering.tif", 
       path = "~/myproject/sc_analysis_project/msc_project/May12th_preprocessing_plots_repeated",
       width = 17, height = 15, device = "tiff")
